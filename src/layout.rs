...
macro_rules! impl_layout {
    ($ty:ident) => {
        impl $ty {
            ...
            pub fn set_position_type(&mut self, position_type: crate::PositionType) {
                self.id.with_any_mut(move |node| {
            ...
            /// edge for this view.
            pub fn set_position(&mut self, edge: crate::Edge, offset: f32) {
                self.id.with_any_mut(move |node| {
                    node.yoga()
            ...
            pub fn set_align_self(&mut self, align: crate::Align) {
                self.id.with_any_mut(move |node| {
            ...
            pub fn set_margin(&mut self, edge: crate::Edge, margin: f32) {
                self.id.with_any_mut(move |node| {
                    node.yoga()
            ...
            pub fn set_padding(&mut self, edge: crate::Edge, padding: f32) {
                self.id.with_any_mut(move |node| {
                    node.yoga()
...
macro_rules! impl_layout_container {
    ($ty:ident) => {
        impl $ty {
            ...
            pub fn set_align_content(&mut self, align: crate::Align) {
                self.id.with_any_mut(move |node| {
            ...
            pub fn set_align_items(&mut self, align: crate::Align) {
                self.id.with_any_mut(move |node| {
            ...
            pub fn set_flex_direction(&mut self, flex_direction: crate::FlexDirection) {
                self.id.with_any_mut(move |node| {
            ...
            pub fn set_flex_wrap(&mut self, wrap: crate::Wrap) {
                self.id.with_any_mut(move |node| {
            ...
            pub fn set_justify_content(&mut self, justify: crate::Justify) {
                self.id.with_any_mut(move |node| {
